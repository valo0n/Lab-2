...
const cartItems = [
  ...
  { id: 2, name: 'Simple Mobile 5G LTE Galexy 12 Mini 512GB Gaming Phone', price: 269, qty: 2, image: '📱' },
];
      ...
      <div className="absolute top-full right-0 mt-2 w-[340px] bg-white rounded-lg shadow-2xl border border-gray-100 z-50 overflow-hidden">
        ...
        <div className="px-4 py-3 border-b border-gray-100">
          <h3 className="text-sm font-semibold text-dark">
            Shopping Cart <span className="text-dark-300 font-normal">({String(cartItems.length).padStart(2, '0')})</span>
          </h3>
        </div>
            ...
            <div key={item.id} className="flex items-start gap-3 px-4 py-3 border-b border-gray-100 last:border-0">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-dark-300">
                  {item.qty} × <span className="text-primary font-semibold">${item.price.toLocaleString()}</span>
                </p>
              </div>
        ...
        <div className="px-4 py-3 border-t border-gray-100">
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="text-sm font-bold text-dark">${subtotal.toFixed(2)} USD</span>
          </div>
